...
#define EEPROM_GPIO_PORT_I2C	GPIOC			/* GPIO端口 */
#define EEPROM_RCC_I2C_PORT 	RCC_APB2Periph_GPIOC		/* GPIO端口时钟 */
#define EEPROM_I2C_SCL_PIN		GPIO_Pin_14			/* 连接到SCL时钟线的GPIO */
#define EEPROM_I2C_SDA_PIN		GPIO_Pin_13			/* 连接到SDA数据线的GPIO */
